...
public class ItemCodeNameDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if(property.propertyType == SerializedPropertyType.Integer)
        {
            ...
            EditorGUI.LabelField(new Rect(position.x, position.y + position.height / 2, position.width, position.height / 2), "Item Name", 
                GetItemName(property.intValue));
    ...
    private string GetItemName(int itemCode)
    {
        ...
        so_ItemList = AssetDatabase.LoadAssetAtPath("Assets/ScriptableObjectAssets/ItemList.asset", typeof(SO_ItemList)) as SO_ItemList;
